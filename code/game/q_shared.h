...
#define	MAX_STRING_CHARS	1024	// max length of a string passed to CmdTokenizeString
#define	MAX_STRING_TOKENS	1024	// max tokens resulting from CmdTokenizeString
